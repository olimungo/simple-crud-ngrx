...
export const ADD_GENRE = '[Movies] Add genre';
export const REMOVE_GENRE = '[Movies] Remove genre';
export const ADD_ACTOR = '[Movies] Add actor';
export const REMOVE_ACTOR = '[Movies] Remove actor';
