...
export class Effects {
  ...
  retrieveForced: Observable<Action> = this.actions
    .ofType(MovieActions.GET_LIST_FORCED)
  ...
  @Effect()
  retrieveActorsForced: Observable<Action> = this.actions
    .ofType(MovieActions.GET_LIST_FORCED)
